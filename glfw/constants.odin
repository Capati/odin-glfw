...
GLFW_SHARED :: glfw.GLFW_SHARED
GLFW_USE_SYSTEM_LIBRARIES :: glfw.GLFW_USE_SYSTEM_LIBRARIES
GLFW_DISABLE_CUSTOM_CALLBACKS :: #config(GLFW_DISABLE_CUSTOM_CALLBACKS, false)
GLFW_DISABLE_CUSTOM_EVENTS :: #config(GLFW_DISABLE_CUSTOM_EVENTS, false)
